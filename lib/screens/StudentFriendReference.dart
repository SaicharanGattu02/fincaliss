...
class FriendReferenceScreen extends StatefulWidget {
  const FriendReferenceScreen({super.key});

  @override
  State<FriendReferenceScreen> createState() => _FriendReferenceScreenState();
}

class _FriendReferenceScreenState extends State<FriendReferenceScreen> {
  ...
  Future<void> _submitUserReference() async {
    print("SubmittingUserReference called");
    ...
    await UserApi.SubmitReferenceapi(
      ...
      if (data != null && data.success == 1) {
        _isLoading = false;
        Navigator.pop(context,"Reference2 Added");
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
            "Reference2 added successfully!",
